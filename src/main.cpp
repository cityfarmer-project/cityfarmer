...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x95e7a47644b7795d34486363ef7e51b717b028aeae7471419c20cb7ad41dc30e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is CITY FAMER COIN. Let's work Together Faming ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1530512220;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085586589;

        if (fTestNet)
        {
            block.nTime    = 1530512227;
            block.nNonce   = 385659599;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x4105e4b1056dee008644ac7cf476b579a706fd275812ec498e2993e839b29476"));
        block.print();
